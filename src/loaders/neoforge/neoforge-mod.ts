/**
 * Represents a mod entry in a NeoForge metadata file.
 */
export interface NeoForgeMod {
    /**
    ...
    /**
     * A table of custom mod properties; this is not used for NeoForge, but is mainly for use by mods.
     */
